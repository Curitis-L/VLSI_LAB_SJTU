...
REM
REM Generated by Vivado on Sun Apr 24 16:20:59 +0800 2022
...
echo "xvlog --incr --relax -prj a1_testbench_vlog.prj"
call xvlog  --incr --relax -prj a1_testbench_vlog.prj -log xvlog.log
