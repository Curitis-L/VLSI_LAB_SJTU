...
REM
REM Generated by Vivado on Sun Apr 24 17:50:51 +0800 2022
...
echo "xvlog --incr --relax -prj a3_testbench_vlog.prj"
call xvlog  --incr --relax -prj a3_testbench_vlog.prj -log xvlog.log
