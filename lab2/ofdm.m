...
OFDM.mod_lev = 1;                                                            % Modulation level : (1) BPSK; (2) QPSK; (4) 16-QAM; (6) 64-QAM
OFDM.mod_order = 2;  %^(OFDM.mod_lev)                        % Modulation order : (2) BPSK; (4) QPSK; (16) 16-QAM; (64) 64-QAM
OFDM.mod_type = 'BPSK';                                            % Modulation type : BPSK/QPSK/16-QAM/64-QAM
...
hold on
ebno0 = 0 : 1 : 11;
ber0 = [0.0786500000000000	0.0562820000000000	0.0375060000000000	0.0228780000000000	0.0125010000000000	0.00595390000000000	0.00238830000000000	0.000772670000000000	0.000190910000000000	3.36270000000000e-05	3.87210000000000e-06	2.61310000000000e-07];
semilogy(ebno0, ber0, 'LineStyle','-', 'Marker','*', 'Color', [1 0 1],'MarkerSize', 11, 'LineWidth', 2);
%legend_label_1 = [OFDM.mod_type,' Theory',' OFDM'];
